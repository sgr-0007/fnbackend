...
public class AucInvoiceHeader {
	...
	public String toString() {
		return "AucInvoiceHeader [invid=" + invid + ", invoiceNo=" + invoiceNo + ", buyerId=" + buyerId + ", buyerNo="
				+ buyerNo + ", noOfBales=" + noOfBales + ", quantityPurchased=" + quantityPurchased + ", value=" + value
				+ ", invoiceDate=" + invoiceDate + ", paymentDueDate=" + paymentDueDate + ", bgBalance=" + bgBalance
				+ ", createdBy=" + createdBy + ", createdOn=" + createdOn + ", updatedBy=" + updatedBy + ", updateOn="
				+ updateOn + ", platformCode=" + platformCode + ", buyerName=" + buyerName + ", isDemurrCalculated="
				+ isDemurrCalculated + ", balanceAfterDlv=" + balanceAfterDlv + ", noOfBalesRelaxed=" + noOfBalesRelaxed
				+ ", insertedDate=" + insertedDate + ", status=" + status + ", voucherStatus=" + voucherStatus + "]";
	}
