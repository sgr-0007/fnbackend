...
public class CompanyDetails {
	...
	public CompanyDetails(int companyid, String companyname, String companyaddress1, String companyaddress2, int cityid,
			int stateid, String pin, String website, String emailid, String gsttin, String pan, String phoneama,String phoneas,
			String mobile, int companytypeid, String regionaloffice, String branchid, boolean isactive, int createdby,
			Date createddate, int modifiedby, Date modifieddate, String statename, String cityname) {
		super();
